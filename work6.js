...
const firebaseConfig = {
  apiKey: "AIzaSyB6pRxMO5-570YKMSCB7wbFt6KLl0ezqZQ",
  authDomain: "web2567-c8829.firebaseapp.com",
  projectId: "web2567-c8829",
  storageBucket: "web2567-c8829.firebasestorage.app",
  messagingSenderId: "479974154625",
  appId: "1:479974154625:web:d114505dbad07adcb4c880",
  measurementId: "G-9XW707WLLV"
};
...
function App() {
  ...
  const [stdTitle, setStdTitle] = useState("นาย"); // default
    ...
    <>
              ...
              <Card.Header>
                <div className="d-flex justify-content-between align-items-center">
                  ...
                  <div>
                    ...
                    <Button variant="success" onClick={autoRead}>
                      Live Sync
                    </Button>
                  </div>
                </div>
              ...
              <Card.Body>
                <Form>
                  ...
                  <Form.Group className="mb-3" controlId="stdTitle">
                    <Form.Label>คำนำหน้า (รวมเพศ)</Form.Label>
                    <Form.Select
                      value={stdTitle}
      ...
      <Container fluid className="mt-4">
        ...
        <p className="text-center text-muted">
          <small>
            By 653380350-5 Ananda Matarach<br />
